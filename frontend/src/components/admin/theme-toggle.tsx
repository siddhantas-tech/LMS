...
export function ThemeToggle() {
    ...
    if (!mounted) {
        ...
        return (
            <div className="h-8 w-8 rounded-full border-2 border-transparent hover:border-foreground hover:bg-muted text-foreground inline-flex items-center justify-center">
